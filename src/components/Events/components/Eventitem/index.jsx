...
const EventItem = ({ info, id, name, image, onEventClick }) => {
    ...
    return (
        <div onClick={() => console.log('padresito click')} className={styles.eventItemContainer}>
            <div className={styles.imageContainer}>
                <img src={isEventLiked ? HearthFilled : HearthUnfilled} alt='Hearth button' className={styles.hearthImage}
